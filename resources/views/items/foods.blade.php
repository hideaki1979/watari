    ...
    <div class="max-w-md mx-auto flex flex-col h-[844px] border border-gray-300 bg-white">
        ...
        <main class="flex-1 overflow-y-auto p-4">
            <div class="grid grid-cols-3 gap-4">
                <img src="https://via.placeholder.com/100" alt="食品1" class="rounded-lg">
                <img src="https://via.placeholder.com/100" alt="食品2" class="rounded-lg">
                <img src="https://via.placeholder.com/100" alt="食品3" class="rounded-lg">
                <img src="https://via.placeholder.com/100" alt="食品4" class="rounded-lg">
                <img src="https://via.placeholder.com/100" alt="食品5" class="rounded-lg">
                <img src="https://via.placeholder.com/100" alt="食品6" class="rounded-lg">
            </div>
        </main>
